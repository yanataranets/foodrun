      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
           <li class="nav-item "><a href="<?php echo base_url(); ?>index.php/restaurant/home" class="nav-link">Home</a></li>
            ...
            <li class="nav-item active"><a href="<?php echo base_url(); ?>index.php/rest_inf/information" class="nav-link">Restaurant Information</a></li>
        ...
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <?php foreach ($data as $item) {?>
                  <table align="center" cellpadding="10"  width="70%" height="100%">
                  <tr>
                      <td style="text-align:right"><h5>Email: </h5></td>
                      <td ><h6><?php echo $item->email ; ?></h6></td>
                  </tr>
                  <tr>
                    <td style="text-align:right"> <h5>Restaurant name: </h5></td>
                    <td><h6><?php echo $item->name; ?>  </h6></td>
                  </tr>
                  <tr>
                    <td style="text-align:right"><h5>Country: </h5></td>
                    <td><h6><?php echo$item->country; ?><h6></td>
                  </tr>
                  <tr>
                    <td style="text-align:right"><h5>City: </h5></td>
                    <td><h6><?php echo $item->city; ?><h6></td>
                  </tr>
                  <tr>
                    <td style="text-align:right"><h5>Address: </h5></td>
                    <td><h6><?php echo $item->street; ?><?php echo $item->building; ?><h6></td>
                  </tr>
                  <tr>
                    <td style="text-align:right"><h5>Сell phone number: </h5></td>
                    <td><h6><?php echo $item->phone ?></h6></td>
                  </tr>
                  </td>
                </table>
                 <?php } ?>

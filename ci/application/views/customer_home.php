...
<head>
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
          <a class="navbar-brand" href="<?php echo base_url(); ?>index.php/customer/home"><img src="https://img.icons8.com/cotton/64/000000/trainers.png"/>Food<br><small>Runner</small></a>
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
          <img src="https://img.icons8.com/plasticine/32/000000/squared-menu.png"/> Menu
          </button>
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active"><a href="<?php echo base_url(); ?>index.php/customer/home" class="nav-link">Home</a></li>
            <li class="nav-item"><a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust" class="nav-link">List of dishes</a></li>
            <li class="nav-item"><a href="<?php echo base_url(); ?>index.php/cust_inf/information" class="nav-link">My information</a></li>
                  ...
                  <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
                    <div class="row">
                      <div class="col-md-4 text-center">
                        <div class="menu-wrap">
                          <a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust" class="menu-img img mb-4" style="background-image: url(<?php echo base_url(); ?>assets/images/dish-1.jpg);"></a>
                          <div class="text">
                            <h3><a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust">Pasta Carbonara</a></h3>
                            ...
                            <p><a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust" class="btn btn-white btn-outline-white">See more</a></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 text-center">
                        <div class="menu-wrap">
                          <a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust" class="menu-img img mb-4" style="background-image: url(<?php echo base_url(); ?>assets/images/dish-2.jpg);"></a>
                          <div class="text">
                            <h3><a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust">Risotto</a></h3>
                      ...
                      <div class="col-md-4 text-center">
                        <div class="menu-wrap">
                          <a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust" class="menu-img img mb-4" style="background-image: url(<?php echo base_url(); ?>assets/images/dish-3.jpg);"></a>
                          <div class="text">
                            <h3><a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust">Tiramisu</a></h3>

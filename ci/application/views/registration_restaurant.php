  ...
  <body>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div>
          ...
          <p><a href="<?php echo base_url(); ?>index.php/auth/registration_user">Not a restaurant? Click here.</a></p>
  			</div>
    	</div>
    </section>
    ...
    <section class="ftco-section ftco-services">
    	...
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <h6>Fill in all the information about your restaurant below</h6>
      ...
      <div class="container">
        <?php  $error = $this->session->flashdata("registration_error")?>
          ...
          <p>Confirm password</p><p><input type="password"   name="confirm-password"/></p>
          <?php $error =form_error("confirm-password", "<small class='text-danger'>", "</small>");?>
          
          <p>Country</p><p><input type="text"   name="country"/></p>
          <?php $error =form_error("country", "<small class='text-danger'>", "</small>");?>
          
          <p>City</p><p><input type="text"   name="city"/></p>
          <?php $error =form_error("city", "<small class='text-danger'>", "</small>");?>
          
          <p>Street</p><p><input type="text"   name="street"/></p>
          <?php $error =form_error("street", "<small class='text-danger'>", "</small>");?>
          
          <p>Building</p><p><input type="text"   name="building"/></p>
          <?php $error =form_error("building", "<small class='text-danger'>", "</small>");?>
          
          <p>Phone</p><p><input type="text"   name="phone"/></p>
          <?php $error =form_error("phone", "<small class='text-danger'>", "</small>");?>
          
          
          <p><input class="btn" type="submit" value="Register" name="submit"/></p>

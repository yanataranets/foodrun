        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
           <li class="nav-item"><a href="<?php echo base_url(); ?>index.php/restaurant/home" class="nav-link">Home</a></li>
            <li class="nav-item active"><a href="<?php echo base_url(); ?>index.php/add/add_dish" class="nav-link">Add dish</a></li>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Add dish information</h2>
            <h6>This description will be seen by the customer in the list of dishes</h6>
          </div>
        </div>
      </div>
    </section>
        ...
        <?php echo $message; ?>
          <?php echo form_open_multipart(); ?>
              <table  align="center" cellpadding="25"cellspacing="10" width="70%" height="120%">
                ...
                <tr>
                  <td><h5>Weight (grams):</h5></td>
                  <td>
                    <?php $error =form_error("weight", "<small class='text-danger'>", '</small>');?>
            ...
            <table align="center">
              <tr>
                  <td>
                    <button type='submit'><img src="https://img.icons8.com/material/24/000000/upload--v1.png"/>Add</button> 
                    <?php echo form_close() ?>
                  </td>
              </tr>
            </table>

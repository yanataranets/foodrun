  ...
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="<?php echo base_url(); ?>index.php/auth/login" class="nav-link">Log In </a></li>
	        </ul>
	      </div>
		  </div>
	  </nav>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div>
  			   ...
  			   <p><a href="<?php echo base_url(); ?>index.php/home/index">Don't have an account yet?</a></p>
        </div>
    	</div>
    ...
    <section class="ftco-section ftco-services">
      ...
      <div class="container">
        ...
        <?php  $error = $this->session->flashdata("error")?>
          ...
          <p><input class="btn" type="submit" value="Login" name="submit"/></p>

      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item "><a href="<?php echo base_url(); ?>index.php/customer/home" class="nav-link">Home</a></li>
            <li class="nav-item active"><a href="<?php echo base_url(); ?>index.php/list_dish/dish_list_cust" class="nav-link">List of dishes</a></li>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">List of available dishes</h2>
          </div>
        </div>
        
        <table align="justify" cellpadding="25"cellspacing="10" width="100%" height="100%">
            <?php if(count($data)): ?>
            <?php foreach ($data as $item) { ?>
              <tr>
                  ...
                  <td>
                  <table align="center" cellpadding="3"  width="120%" height="100%">
                  <tr>
                      <td><h6>Name: </h6></td>
                  ...
                  <tr>
                    ...
                    <td><h6><?php echo $item->description; ?></h6></td>
                  </tr>
                  <tr>
                    <td><h6>Price: </h6></td>
                    <td><h6><?php echo $item->price; ?> €<h6></td>
                  </tr>
                  <tr>
                    <td><h6>Weight: </h6></td>
                    <td><h6><?php echo $item->weight; ?> (g)<h6></td>
                  </tr>
                  <tr>
                    <td><h6>Restaurant name: </h6></td>
                    <td><h6><?php echo $item->rest_name; ?><h6></td>
                  </tr>
                  </td>
                </table>
              </tr>
